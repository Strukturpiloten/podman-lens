...
pub use observation::{
    ...
    NativeNetworkAliasKind, NativeNetworkAliasObservation, NativeNetworkAttachmentObservation, NativeNetworkCidr,
    NativeNetworkLeaseRange, NativeNetworkRouteObservation, NativeNetworkRouteType, NativeNetworkSubnetObservation,
    NativeNetworkingObservation, NativeOpaqueNetworkOptions, NativeOpaqueSecurityOptions, NativePortBindingObservation,
    NativePortProtocol, NativeResourceControlObservation, NativeResourceReference, NativeRestartPolicyName,
    ...
    ResourceDetails, ResourceObservation, ResourceObservationState, SecretObservation, UnixId as ObservedUnixId,
    UnmodelledCompleteness, UnmodelledField, UnmodelledFieldId, VolumeObservation, VolumeOwnerIdWireValue,
};
