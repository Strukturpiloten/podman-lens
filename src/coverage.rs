...
const EXPECTED_INPUT_ENTRIES: &[ExpectedInputEntry] = &[
    ...
    expected!(
        ...
        "observation-only",
        "inventory::decode_container_networking",
        "not_applicable",
        "not_applicable",
        "NativeNetworkingObservation::create_net_ns",
        "PLN0017",
        "tests::inventory::unpodded_host_config_networking_is_configured_and_management_gates_are_fail_closed",
        "tests::inventory::unpodded_port_bindings_are_validated_without_a_new_network_namespace_gate"
    ),
    expected!(
        "PLN-FLD-0070",
        "container",
        ...
        "not_applicable",
        "not_applicable",
        "NativeNetworkingObservation::port_bindings",
        "PLN0017",
        "tests::inventory::unpodded_host_config_networking_is_configured_and_management_gates_are_fail_closed",
        "tests::inventory::unpodded_port_bindings_are_validated_without_a_new_network_namespace_gate"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "NativeNetworkingObservation::dns_servers",
        "PLN0017",
        "tests::inventory::unpodded_host_config_networking_is_configured_and_management_gates_are_fail_closed",
        "tests::inventory::public_typed_observations_exercise_every_field_state_without_promoting_unmodelled_data"
    ),
    expected!(
        "PLN-FLD-0072",
        "container",
        ...
        "not_applicable",
        "not_applicable",
        "NativeNetworkingObservation::dns_search",
        "PLN0017",
        "tests::inventory::unpodded_host_config_networking_is_configured_and_management_gates_are_fail_closed",
        "tests::inventory::public_typed_observations_exercise_every_field_state_without_promoting_unmodelled_data"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "NativeNetworkingObservation::dns_options",
        "PLN0017",
        "tests::inventory::unpodded_host_config_networking_is_configured_and_management_gates_are_fail_closed",
        "tests::inventory::public_typed_observations_exercise_every_field_state_without_promoting_unmodelled_data"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "NativeNetworkingObservation::no_manage_resolv_conf",
        "PLN0017",
        "tests::inventory::unpodded_host_config_networking_is_configured_and_management_gates_are_fail_closed",
        "tests::inventory::public_typed_observations_exercise_every_field_state_without_promoting_unmodelled_data"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "NativeNetworkingObservation::no_manage_hosts",
        "PLN0017",
        "tests::inventory::unpodded_host_config_networking_is_configured_and_management_gates_are_fail_closed",
        "tests::inventory::public_typed_observations_exercise_every_field_state_without_promoting_unmodelled_data"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "NativeNetworkingObservation::host_entries",
        "PLN0023",
        "tests::inventory::unpodded_host_config_networking_is_configured_and_management_gates_are_fail_closed",
        "tests::inventory::public_typed_observations_exercise_every_field_state_without_promoting_unmodelled_data"
    ),
    expected!(
        ...
        "$.CreateInfra",
        "observation-only",
        "inventory::decode_pod_networking",
        "not_applicable",
        "not_applicable",
        "PodObservation::create_infra",
        "PLN0017",
        "tests::inventory::pod_infra_networking_is_authoritative_and_member_runtime_networking_is_not_promoted",
        "tests::inventory::infra_configuration_inconsistencies_and_malformed_members_fail_closed"
    ),
    expected!(
        "PLN-FLD-0078",
        "pod",
    ...
    expected!(
        ...
        "observation-only",
        "inventory::decode_native_networking",
        "not_applicable",
        "not_applicable",
        "NativeNetworkingObservation::port_bindings",
        "PLN0017",
    ...
    expected!(
        "PLN-FLD-0080",
        "pod",
        "$.InfraConfig.HostNetwork",
        "observation-only",
        "inventory::decode_native_networking",
        "not_applicable",
        "not_applicable",
        "NativeNetworkingObservation::host_network",
        "PLN0017",
        "tests::inventory::pod_infra_networking_is_authoritative_and_member_runtime_networking_is_not_promoted",
        "tests::inventory::infra_configuration_inconsistencies_and_malformed_members_fail_closed"
    ),
    ...
    expected!(
        ...
        "PLN0017",
        "tests::inventory::pod_infra_networking_is_authoritative_and_member_runtime_networking_is_not_promoted",
        "tests::discovery::one_malformed_relationship_member_blocks_its_entire_collection"
    ),
    expected!(
        "PLN-FLD-0086",
        "pod",
        "$.InfraConfig.NetworkOptions",
        "observation-only",
        "inventory::decode_native_networking",
        "not_applicable",
        "not_applicable",
        "NativeNetworkingObservation::network_options",
        "PLN0017",
        "tests::inventory::pod_infra_networking_is_authoritative_and_member_runtime_networking_is_not_promoted",
        "tests::inventory::infra_configuration_inconsistencies_and_malformed_members_fail_closed"
    ),
    expected!(
        "PLN-FLD-0087",
        "pod",
        "$.InfraConfig.NoManageResolvConf",
        "observation-only",
        "inventory::decode_native_networking",
        "not_applicable",
        "not_applicable",
    ...
    expected!(
        ...
        "observation-only",
        "inventory::decode_container_b3",
        "not_applicable",
        "not_applicable",
        "ContainerObservation::restart_policy",
        "PLN0017",
        "tests::inventory::container_restart_health_and_logging_are_typed_effective_observations",
        "tests::inventory::container_b3_malformed_counts_and_commands_fail_closed"
    ),
    expected!(
        "PLN-FLD-0092",
        "container",
        ...
        "observation-only",
        "inventory::decode_native_restart_policy",
        "not_applicable",
        "not_applicable",
        "NativeRestartPolicyObservation::name",
        "PLN0023",
        "tests::inventory::container_restart_health_and_logging_are_typed_effective_observations",
        "tests::inventory::container_b3_unknown_enums_are_bounded_unmodelled_metadata"
    ),
    expected!(
        "PLN-FLD-0093",
        "container",
        ...
        "not_applicable",
        "not_applicable",
        "NativeRestartPolicyObservation::maximum_retry_count",
        "PLN0017",
        "tests::inventory::container_restart_health_and_logging_are_typed_effective_observations",
        "tests::inventory::container_b3_malformed_counts_and_commands_fail_closed"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "ContainerObservation::health_check",
        "PLN0017",
        "tests::inventory::container_restart_health_and_logging_are_typed_effective_observations",
        "tests::inventory::container_b3_malformed_counts_and_commands_fail_closed"
    ),
    expected!(
        ...
        "observation-only",
        "inventory::decode_native_health_check",
        "not_applicable",
        "not_applicable",
        "NativeHealthCheckObservation::command",
        "PLN0023",
        "tests::inventory::container_restart_health_and_logging_are_typed_effective_observations",
        "tests::inventory::container_b3_unknown_enums_are_bounded_unmodelled_metadata"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "NativeHealthCheckObservation::interval",
        "PLN0017",
        "tests::inventory::container_restart_health_and_logging_are_typed_effective_observations",
        "tests::inventory::container_b3_malformed_counts_and_commands_fail_closed"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "NativeHealthCheckObservation::timeout",
        "PLN0017",
        "tests::inventory::container_restart_health_and_logging_are_typed_effective_observations",
        "tests::inventory::container_b3_malformed_counts_and_commands_fail_closed"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "NativeHealthCheckObservation::retries",
        "PLN0017",
        "tests::inventory::container_restart_health_and_logging_are_typed_effective_observations",
        "tests::inventory::container_b3_malformed_counts_and_commands_fail_closed"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "NativeHealthCheckObservation::start_period",
        "PLN0017",
        "tests::inventory::container_restart_health_and_logging_are_typed_effective_observations",
        "tests::inventory::container_b3_malformed_counts_and_commands_fail_closed"
    ),
    expected!(
        ...
        "observation-only",
        "inventory::decode_native_health_failure_action",
        "not_applicable",
        "not_applicable",
        "ContainerObservation::health_failure_action",
        "PLN0023",
        "tests::inventory::container_restart_health_and_logging_are_typed_effective_observations",
        "tests::inventory::container_b3_unknown_enums_are_bounded_unmodelled_metadata"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "ContainerObservation::startup_health_check",
        "PLN0017",
        "tests::inventory::container_restart_health_and_logging_are_typed_effective_observations",
        "tests::inventory::container_b3_malformed_counts_and_commands_fail_closed"
    ),
    expected!(
        ...
        "observation-only",
        "inventory::decode_native_startup_health_check",
        "not_applicable",
        "not_applicable",
        "NativeStartupHealthCheckObservation::command",
        "PLN0023",
        "tests::inventory::container_restart_health_and_logging_are_typed_effective_observations",
        "tests::inventory::container_b3_unknown_enums_are_bounded_unmodelled_metadata"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "NativeStartupHealthCheckObservation::interval",
        "PLN0017",
        "tests::inventory::container_restart_health_and_logging_are_typed_effective_observations",
        "tests::inventory::container_b3_malformed_counts_and_commands_fail_closed"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "NativeStartupHealthCheckObservation::timeout",
        "PLN0017",
        "tests::inventory::container_restart_health_and_logging_are_typed_effective_observations",
        "tests::inventory::container_b3_malformed_counts_and_commands_fail_closed"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "NativeStartupHealthCheckObservation::retries",
        "PLN0017",
        "tests::inventory::container_restart_health_and_logging_are_typed_effective_observations",
        "tests::inventory::container_b3_malformed_counts_and_commands_fail_closed"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "NativeStartupHealthCheckObservation::start_period",
        "PLN0017",
        "tests::inventory::container_restart_health_and_logging_are_typed_effective_observations",
        "tests::inventory::container_b3_malformed_counts_and_commands_fail_closed"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "NativeStartupHealthCheckObservation::successes",
        "PLN0017",
        "tests::inventory::container_restart_health_and_logging_are_typed_effective_observations",
        "tests::inventory::container_b3_malformed_counts_and_commands_fail_closed"
    ),
    ...
    expected!(
        ...
        "observation-only",
        "inventory::decode_native_logging",
        "not_applicable",
        "not_applicable",
        "NativeLoggingObservation::driver",
        "PLN0023",
        "tests::inventory::container_restart_health_and_logging_are_typed_effective_observations",
        "tests::inventory::container_b3_unknown_enums_are_bounded_unmodelled_metadata"
    ),
    ...
    expected!(
        ...
        "observation-only",
        "inventory::decode_native_security",
        "not_applicable",
        "not_applicable",
        "NativeSecurityObservation::privileged",
        "PLN0017",
    ...
    expected!(
        ...
        "$.HostConfig.CapAdd",
        "observation-only",
        "inventory::native_capabilities",
        "not_applicable",
        "not_applicable",
        "NativeSecurityObservation::cap_add",
        "PLN0023",
        "tests::inventory::container_security_namespaces_and_resources_are_typed_effective_observations",
        "tests::inventory::container_b3b_unknown_capabilities_and_namespace_modes_are_unmodelled"
    ),
    expected!(
        "PLN-FLD-0113",
        "container",
        ...
        "not_applicable",
        "not_applicable",
        "NativeSecurityObservation::cap_drop",
        "PLN0023",
        "tests::inventory::container_security_namespaces_and_resources_are_typed_effective_observations",
        "tests::inventory::container_b3b_unknown_capabilities_and_namespace_modes_are_unmodelled"
    ),
    expected!(
        ...
        "observation-only",
        "inventory::native_security_options",
        "not_applicable",
        "not_applicable",
        "NativeSecurityObservation::security_options",
        "PLN0017",
        "tests::inventory::container_security_namespaces_and_resources_are_typed_effective_observations",
        "tests::inventory::container_b3b_malformed_fields_fail_closed"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "NativeSecurityObservation::read_only_root_filesystem",
        "PLN0017",
        "tests::inventory::container_security_namespaces_and_resources_are_typed_effective_observations",
        "tests::inventory::container_b3b_malformed_fields_fail_closed"
    ),
    expected!(
        ...
        "$.HostConfig.PidMode",
        "observation-only",
        "inventory::native_namespace_mode",
        "not_applicable",
        "not_applicable",
        "NativeNamespaceObservation::pid",
        "PLN0023",
        "tests::inventory::container_security_namespaces_and_resources_are_typed_effective_observations",
        "tests::inventory::container_b3b_unknown_capabilities_and_namespace_modes_are_unmodelled"
    ),
    expected!(
        ...
        "$.HostConfig.IpcMode",
        "observation-only",
        "inventory::native_ipc_namespace_mode",
        "not_applicable",
        "not_applicable",
        "NativeNamespaceObservation::ipc",
        "PLN0023",
        "tests::inventory::container_security_namespaces_and_resources_are_typed_effective_observations",
        "tests::inventory::container_b3b_unknown_capabilities_and_namespace_modes_are_unmodelled"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "NativeNamespaceObservation::uts",
        "PLN0023",
        "tests::inventory::container_security_namespaces_and_resources_are_typed_effective_observations",
        "tests::inventory::container_b3b_unknown_capabilities_and_namespace_modes_are_unmodelled"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "NativeNamespaceObservation::cgroup",
        "PLN0023",
        "tests::inventory::container_security_namespaces_and_resources_are_typed_effective_observations",
        "tests::inventory::container_b3b_unknown_capabilities_and_namespace_modes_are_unmodelled"
    ),
    expected!(
        ...
        "observation-only",
        "inventory::decode_native_resource_controls",
        "not_applicable",
        "not_applicable",
        "NativeResourceControlObservation::cpu_shares",
        "PLN0017",
        "tests::inventory::container_security_namespaces_and_resources_are_typed_effective_observations",
        "tests::inventory::container_b3b_malformed_fields_fail_closed"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "NativeResourceControlObservation::cpu_period",
        "PLN0017",
        "tests::inventory::container_security_namespaces_and_resources_are_typed_effective_observations",
        "tests::inventory::container_b3b_malformed_fields_fail_closed"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "NativeResourceControlObservation::cpu_quota",
        "PLN0017",
        "tests::inventory::container_security_namespaces_and_resources_are_typed_effective_observations",
        "tests::inventory::container_b3b_malformed_fields_fail_closed"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "NativeResourceControlObservation::memory",
        "PLN0017",
        "tests::inventory::container_security_namespaces_and_resources_are_typed_effective_observations",
        "tests::inventory::container_b3b_malformed_fields_fail_closed"
    ),
    expected!(
        ...
        "not_applicable",
        "not_applicable",
        "NativeResourceControlObservation::pids_limit",
        "PLN0017",
        "tests::inventory::container_security_namespaces_and_resources_are_typed_effective_observations",
        "tests::inventory::container_b3b_malformed_fields_fail_closed"
    ),
    expected!(
        ...
        "$.HostConfig.Ulimits",
        "observation-only",
        "inventory::decode_native_ulimits",
        "not_applicable",
        "not_applicable",
        "NativeResourceControlObservation::ulimits",
        "PLN0017",
        "tests::inventory::container_security_namespaces_and_resources_are_typed_effective_observations",
        "tests::inventory::container_b3b_malformed_fields_fail_closed"
    ),
    ...
    expected!(
        "PLN-FLD-0127",
        "container",
        "$.HostConfig.Ulimits[].Soft",
        "observation-only",
        "inventory::decode_native_ulimits",
        "not_applicable",
        "not_applicable",
        "NativeUlimitObservation::soft",
        "PLN0017",
        "tests::inventory::container_security_namespaces_and_resources_are_typed_effective_observations",
        "tests::inventory::container_b3b_malformed_fields_fail_closed"
    ),
    expected!(
        "PLN-FLD-0128",
        "container",
        "$.HostConfig.Ulimits[].Hard",
        "observation-only",
        "inventory::decode_native_ulimits",
        "not_applicable",
        "not_applicable",
        "NativeUlimitObservation::hard",
        "PLN0017",
        "tests::inventory::container_security_namespaces_and_resources_are_typed_effective_observations",
        "tests::inventory::container_b3b_malformed_fields_fail_closed"
    ),
