...
pub use observation::{
    ...
    NativePortBindingObservation, NativePortProtocol, NativeResourceReference, NativeRestartPolicyName,
    NativeRestartPolicyObservation, NativeStartupHealthCheckObservation, NetworkObservation, NetworkOptionKeys,
